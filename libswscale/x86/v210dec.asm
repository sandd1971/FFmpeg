...
; v210_decode(const uint32_t *src, uint16_t *y, uint16_t *u, uint16_t *v, ptrdiff_t width)
cglobal v210_decode_%1_%2, 5, 5, 6 + 2 * cpuflag(avx2), src, y, u, v, w
    lea    yq, [yq+2*wq]
    add    uq, wq
    add    vq, wq
    neg    wq
...
INIT_XMM ssse3
v210_decode unaligned, 10
v210_decode aligned, 10
v210_decode unaligned, 16
v210_decode aligned, 16
